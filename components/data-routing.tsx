...
const DataRouting: NextPage = () => {
  return (
    <section className="w-[1200px] flex flex-col items-start justify-start gap-[24px_0px] max-w-full text-left text-xl text-neutral-00 font-caption-1-regular">
      ...
      <div className="self-stretch flex flex-row flex-wrap items-start justify-start gap-[0px_19.95px] max-w-full text-lg">
        <MultiplyingNode />
        <div className="flex-1 rounded-2xl bg-surface-color-surface-2 box-border overflow-hidden flex flex-col items-start justify-start py-4 px-[15px] gap-[18px_0px] min-w-[290px] max-w-full border-[1px] border-solid border-line-2">
          <MedianNode />
          <div className="self-stretch flex flex-col items-start justify-start max-w-full text-center">
            <div className="self-stretch flex flex-row items-start justify-start py-[8.5px] px-0 gap-[0px_10px] mq450:flex-wrap">
            ...
            <div className="self-stretch flex flex-row items-end justify-start max-w-full">
              <div className="h-10 flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-[8.5px] box-border gap-[8.5px_0px] max-w-full mq450:h-auto">
                ...
                <div className="self-stretch flex flex-row items-start justify-start gap-[0px_10px] mq450:flex-wrap">
                  <div className="flex flex-col items-start justify-start pt-[1.5px] px-0 pb-0">
                    <img
                      className="w-5 h-5 relative overflow-hidden shrink-0"
                      alt=""
            ...
            <div className="self-stretch flex flex-row items-center justify-between py-2 pr-[0.10000000000002274px] pl-0 gap-[20px] mq450:flex-wrap">
