...
const LogicTree: NextPage = () => {
  return (
    <header className="w-[1200px] flex flex-row items-start justify-center pt-0 px-0 pb-[15px] box-border max-w-full text-left text-xs text-neutral-00 font-caption-1-regular">
